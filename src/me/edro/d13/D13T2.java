...
public class D13T2 {
    ...
    public static void main(String[] args) {
        ...
        allPackets.add(new JSONArray("[[2]]"));
        allPackets.add(new JSONArray("[[6]]"));
        ...
        allPackets.sort(D13T2::compareLists);

        int index = 1;
        for(JSONArray p: allPackets){
            System.out.println(p);
            if (p.toString().equals("[[2]]") || p.toString().equals("[[6]]")){
                sum *= index;
            }
            index++;
        }
